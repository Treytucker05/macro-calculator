...
/**
 * Render the calculation outcome into #macroResults
 * @param {Object} result   – return object from getMacros()
 * @param {number} meals    – user-selected meals per day
 */
function renderResults(result, meals) {
  const { calories, protein, fats, carbs, perMeal, messages } = result;
